...
function DevBanner({ user }) {
  ...
  return (
    <div style={styles.devBanner}>
      ...
      <span>
        <strong>Dev Mode</strong> — SSO is mocked. API calls are simulated. Location:{' '}
        <code style={styles.devCode}>{user?.locationId}</code>
      </span>
    </div>
  );
}
      ...
      <div style={styles.container}>
        ...
        <div style={styles.connectedCard}>
          ...
          <div style={styles.connectedNote}>
            ...
            <span>
              Messages sent to <strong>@{botInfo.username}</strong> on Telegram will appear in your
              GHL Conversations tab.
            </span>
          </div>
        ...
        {showDisconnectConfirm && (
          <div style={styles.modalOverlay}>
            <div style={styles.modal}>
              ...
              <p style={styles.modalText}>
                This will stop syncing messages between Telegram and GoHighLevel for this location.
                Your existing conversation history in GHL will be preserved.
              </p>
              <div style={styles.modalActions}>
                <button style={styles.secondaryBtn} onClick={() => setShowDisconnectConfirm(false)}>
                  Cancel
                </button>
    ...
    <div style={styles.container}>
        ...
        <div style={styles.headerLeft}>
          ...
          <div>
            ...
            <p style={styles.subtitle}>
              Connect your Telegram bot to receive and send messages from GoHighLevel
            </p>
          </div>
        </div>
      </div>
      ...
      <div style={styles.setupCard}>
        ...
        <p style={styles.setupDescription}>
          ...
          don't have one yet, follow the instructions below.
        </p>
        ...
        {showInstructions && (
          <div style={styles.instructionsCard}>
            ...
            <div style={styles.instructionsTip}>
              ...
              <span>
                Already have a bot? Just paste the token below. You can find it by messaging{' '}
                <strong>@BotFather</strong> and sending <code style={styles.code}>/mybots</code>.
              </span>
            </div>
          </div>
        )}
        ...
        <div style={styles.inputGroup}>
          ...
          {IS_DEV && !botToken && (
            <p style={styles.devHint}>
              ...
              <code style={styles.devCode}>123456789:ABCdefGHIjklMNOpqrsTUVwxyz12345678901</code> to
              test the flow.
            </p>
          )}
        </div>
